...
textinput_user_text_font = "Times"  # 'None' will use default system font
...
menu_gap = 2
menu_position = (0, 0)
menu_background_colour = _constants.C_BLACK
menu_heading_font = "Helvetica"
menu_text_font = "Helvetica"
menu_text_colour = _constants.C_GREY
menu_heading_text_colour = _constants.C_EXPYRIMENT_ORANGE
menu_select_background_colour = _constants.C_DARKGREY
menu_select_text_colour = [0, 0, 0]
menu_select_frame_colour = _constants.C_EXPYRIMENT_ORANGE
menu_select_frame_line_width = 0
menu_justification = 1
menu_scroll_menu = 0
